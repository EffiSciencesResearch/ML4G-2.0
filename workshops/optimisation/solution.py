...
if MAIN:
    optim_tests.test_mlp(ImageMemorizer)
...
if MAIN:
    optim_tests.test_tensor_dataset(TensorDataset)
...
if MAIN:
    optim_tests.test_train(train_one_epoch)
...
if MAIN:
    optim_tests.test_evaluate(evaluate)
...
if MAIN:
    optim_tests.test_rmsprop(RMSprop)
"""
### Adam
"""
